...
export const ECommerceIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 100 75" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <rect x="10" y="30" width="50" height="35" fill="url(#ecomGradient)" />
...
export const CorporateWebsiteIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 100 75" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <rect x="40" y="30" width="50" height="8" fill="url(#corpGradient)" />
...
export const PortfolioShowcaseIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 100 75" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      <radialGradient id="portfolioGradient">
        <stop offset="0%" stopColor="#f59e0b" />
        <stop offset="100%" stopColor="#ef4444" />
      </radialGradient>
    </defs>
    <rect width="100" height="75" rx="4" fill="hsl(var(--card))" />
    <circle cx="50" cy="38" r="18" fill="url(#portfolioGradient)" />
...
export const SaasLandingPageIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 100 75" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <rect x="25" y="25" width="20" height="20" fill="hsl(var(--primary))" rx="2" />
    <rect x="55" y="25" width="25" height="5" fill="hsl(var(--primary))" opacity="0.6" />
    <rect x="55" y="35" width="25" height="5" fill="hsl(var(--primary))" opacity="0.4" />
    <rect x="55" y="45" width="15" height="5" fill="hsl(var(--primary))" opacity="0.2" />
  </svg>
);
